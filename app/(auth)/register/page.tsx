      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#1e293b] rounded-2xl border border-slate-700/50 p-8 shadow-2xl shadow-black/40">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-slate-800 font-semibold py-3 rounded-lg hover:bg-slate-100 transition-all text-sm shadow-sm mb-5"
          >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-slate-500">atau daftar dengan email</span>
            <div className="flex-1 h-px bg-slate-700" />
          </div>
